...
void tabulate(void)
{
    ...
    for (int voter = 0; voter < voter_count; voter++)
    {
        ...
        {
            if (candidates[preferences[voter][ranks]].eliminated    ==  false)
            {
                candidates[preferences[voter][ranks]].votes++;
                break;
            }
        }
    }
...
{
    // TODO
    //this function eliminates the candidate with the least votes
    for (int i = 0; i < candidate_count; i++)
    {
